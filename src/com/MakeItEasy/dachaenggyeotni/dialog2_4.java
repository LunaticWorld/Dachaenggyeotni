...
public class dialog2_4 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.dialoglayout2_4);

		
		img1 = (ImageView) findViewById(R.id.img1);
		img1.setScaleType(ImageView.ScaleType.FIT_CENTER);
		
		next_btn = (Button) findViewById(R.id.new_next_btn3);
		...
		prv_btn = (Button) findViewById(R.id.new_prv_btn3);
